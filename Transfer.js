...
const [acc2, setAccount] = useState("");
...
const handleSubmit = async () => {
    await axios({
        ...
        url: 'http://192.168.0.106:8080/transfer/'+accno+'/'+acc2+'/'+amount,
        data: {
          accno:accno,
          acc2:acc2,
          amount:amount,    
 ...
 return (
    ...
    <Text style={styles.headertxt}>Transfer</Text>
    </View>
    ...
    <Text style={{alignItems:'center',fontSize:17,color:'black',fontWeight:'bold',marginTop:10}}>Account no: {accno}</Text>
     ...
     <TouchableOpacity 
               ...
               <Text style={styles.buttontxt}>Confirm Transfer</Text>
     </TouchableOpacity>    
     </View>
  </View>
)
